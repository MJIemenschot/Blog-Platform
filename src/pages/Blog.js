const Blog = () => {
    return (
        <div>
        <h1>Blog titel</h1>
        <p>Consectetur adipisicing elit. Blanditiis cum, dolor ea enim fugiat fugit id inventore ipsam libero magni modi natus
            ...
            provident quos, similique sit totam vero. Beatae consequatur cupiditate rerum?</p>
        </div>
